...
export function LuxeTemplate({ business, services, hours, theme }: LuxeTemplateProps) {
    ...
    <div className="min-h-screen font-sans" style={{ backgroundColor: bg, color: ink }}>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-3xl px-6">
          <h2
            className="mb-12 text-center text-3xl font-medium tracking-[-0.02em] md:text-4xl"
            style={{ fontFamily: displayFont, fontWeight: displayWeight }}
          >
            Services
          </h2>
