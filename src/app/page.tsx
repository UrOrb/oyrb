      ...
      <section className="border-t border-[#E7E5E4] py-24 md:py-32">
        <div className="mx-auto max-w-[1200px] px-6">
          <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h2 className="font-display mt-3 text-3xl font-medium tracking-[-0.02em] md:text-5xl">
                27 themes. 5 layouts.<br className="hidden md:block" /> Your signature style.
              </h2>
              <p className="mt-4 max-w-lg text-[#525252]">
                From soft &amp; feminine to bold editorial to streetwear-inspired. 135 total combinations — pick a palette, pick a layout, launch in minutes.
              </p>
            </div>
          </div>
          ...
          <div className="mt-10 flex justify-center md:mt-12">
            ...
            >
              Browse all 135 templates <ArrowRight size={14} />
            </Link>
          </div>
        </div>
      </section>
