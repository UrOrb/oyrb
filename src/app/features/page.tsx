...
const SECTIONS: Section[] = [
  {
    ...
    body: "105 professionally designed templates across 5 layouts and 21 themes — built specifically for beauty professionals. Customize your colors, fonts, and content. Switch templates anytime without losing your data.",
    visual: "#EDE8E3",
