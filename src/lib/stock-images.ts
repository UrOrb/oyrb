...
export const STOCK_LIBRARY: Record<string, Category> = {
  ...
  locs: {
    label: "Locs & natural hair",
    description: "Loc maintenance, twists, braids, textured hair, natural styling",
    query: "natural hair locs salon",
    orientation: "portrait",
    fallbackIds: [
      "1542838132-92c53300491e", "1552374196-c4e7ffc6e126",
      "1623428187969-5da2dcea5ebf", "1522337094846-8a818192de1f",
      "1519699047748-de8e457a634e", "1582095133179-bfd08e2fc6b3",
      "1531746020798-e6953c6e8e04", "1562259929-b4e1fd3aef09",
      "1519014816548-bf5fe059798b", "1509783236416-c9ad59bae472",
    ],
  },
  nails: {
    label: "Nails",
  ...
  hair_removal: {
    ...
    description: "Waxing, sugaring, laser hair removal, body aesthetic treatments",
    query: "waxing studio skincare",
    orientation: "squarish",
    fallbackIds: [
      "1515377905703-c4788e51af15", "1508214751196-bcfd4ca60f91",
      "1556228720-195a672e8a03", "1620916566398-39f1143ab7be",
      "1519415943484-9fa1873496d4", "1595152452543-e5fc28ebc2b8",
      "1527239441953-caffd968d952", "1606107557195-0e29a4b5b4aa",
      "1505932794465-147d1f1b2c97", "1612817288484-6f916006741a",
    ],
  },
  pmu: {
    label: "Permanent makeup (PMU)",
    description: "Microblading, lip blush, permanent eyeliner, brow mapping",
    query: "microblading permanent makeup",
    orientation: "squarish",
    fallbackIds: [
      "1523264939339-c89f9dadde2e", "1487412720507-e7ab37603c6f",
      "1516975080664-ed2fc6a32937", "1580618672591-eb180b1a973f",
      "1588361861040-ac9b1018f6d5", "1618410320928-25228d811631",
      "1567892737950-30c4db37cd89", "1626954079979-ec4f7b05e032",
      "1552374196-c4e7ffc6e126", "1562259949-e8e7689d7828",
    ],
  ...
  massage: {
    ...
    description: "Massage therapy, bodywork, spa rooms, holistic treatment spaces",
    query: "massage therapy spa",
    orientation: "landscape",
    fallbackIds: [
      "1612817288484-6f916006741a", "1556228720-195a672e8a03",
      "1620916566398-39f1143ab7be", "1515377905703-c4788e51af15",
      "1508214751196-bcfd4ca60f91", "1595152452543-e5fc28ebc2b8",
      "1527239441953-caffd968d952", "1519415943484-9fa1873496d4",
      "1580196969807-cc6de06c05be", "1560963805-6c64417e3413",
    ],
  },
  holistic_spa: {
    label: "Holistic & spa services",
    description: "Spa rituals, aromatherapy, wellness treatments, holistic beauty rooms",
    query: "holistic spa wellness",
    orientation: "landscape",
    fallbackIds: [
  ...
  tanning: {
    label: "Tanning",
    description: "Airbrush tanning, glow studios, bronzing treatments, sunless tan prep",
    query: "airbrush tanning studio",
    orientation: "squarish",
    fallbackIds: [
      "1508214751196-bcfd4ca60f91", "1515377905703-c4788e51af15",
      "1556228720-195a672e8a03", "1620916566398-39f1143ab7be",
      "1519415943484-9fa1873496d4", "1595152452543-e5fc28ebc2b8",
      "1505932794465-147d1f1b2c97", "1606107557195-0e29a4b5b4aa",
      "1527239441953-caffd968d952", "1612817288484-6f916006741a",
    ],
  },
  tooth_gems: {
    label: "Tooth gems & oral aesthetics",
    description: "Tooth gems, cosmetic accents, oral aesthetics, detail-focused beauty",
    query: "tooth gems beauty",
    orientation: "squarish",
    fallbackIds: [
      "1487412720507-e7ab37603c6f", "1523264939339-c89f9dadde2e",
      "1516975080664-ed2fc6a32937", "1580618672591-eb180b1a973f",
      "1503443207922-dff7d543fd0e", "1521123845560-14093637aa7d",
      "1562259949-e8e7689d7828", "1588361861040-ac9b1018f6d5",
      "1618410320928-25228d811631", "1507003211169-0a1dd7228f2d",
    ],
  },
  makeup: {
